                ...
                <div class="p-8 flex-1">
                    <div class="w-80 bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">
                        ...
                        <div class="px-10 pt-4 pb-8 bg-white rounded-tr-4xl">
                            <h1 class="text-2xl font-semibold text-gray-700">Bienvenido Nuevamente!</h1>
                            <form class="mt-12" action="" method="POST">
                                ...
                                <input type="sumbit" value="Acceder" class="mt-20 px-4 py-2 rounded bg-purple-800 hover:bg-purple-400 text-white font-semibold text-center block w-full focus:outline-none focus:ring focus:ring-offset-2 focus:ring-rose-500 focus:ring-opacity-80 cursor-pointer" />
                            </form>
                            <a href="#" class="mt-4 block text-sm text-center font-medium text-purple-600 hover:underline focus:outline-none focus:ring-2 focus:ring-rose-500"> Forgot your password? </a>
                        </div>
                    </div>
                </div>
            </div>
