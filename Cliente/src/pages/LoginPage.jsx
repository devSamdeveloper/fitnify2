                ...
                <div className='p-8 flex-1'>
                    <div className='w-80 bg-white rounded-3xl mx-auto overflow-hidden shadow-xl'>
                        ...
                        <div className='px-10 pt-4 pb-8 bg-white rounded-tr-4xl'>
                            <h1 className='text-2xl font-semibold text-gray-700'>Accede a tu Cuenta!</h1>
                            ...
                            <form onSubmit={submit} className='mt-12'>
                                ...
                                <button type='submit' className='mt-20 px-4 py-2 rounded bg-purple-800 hover:bg-purple-400 text-white font-semibold text-center block w-full focus:outline-none focus:ring focus:ring-offset-2 focus:ring-rose-500 focus:ring-opacity-80 cursor-pointer'>Acceder</button>
                            </form>
                        </div>
                    </div>
                </div>
